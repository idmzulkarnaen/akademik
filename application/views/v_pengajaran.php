	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Pengajaran</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<a href='<?php echo base_url('pengajaran/tambah');?>' class='btn btn-primary' title='Tambah'><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Tambah</a>
						...
						<table class="table table-bordered table-hover" id="table1">
			                ...
			                foreach ($result as $row) {
			                	...
			                	if($row->JENISKULIAH=="T")$jenis = "Teori";
			                	else $jenis = "Praktikum";
			                  ...
			                  echo "
			                  <a href='".base_url('pengajaran/edit/'.$row->IDKULIAH)."' class='btn btn-warning' title='Edit'><svg class='glyph stroked pencil'><use xlink:href='#stroked-pencil'/></svg></a>
			                  <a href='".base_url('pengajaran/proseshapus/'.$row->IDKULIAH)."' onclick='return confirm(\"Hapus data ?\");' class='btn btn-danger' title='Hapus'><svg class='glyph stroked trash'><use xlink:href='#stroked-trash'/></svg>
